...
const __dirname$1 = path.dirname(node_url.fileURLToPath(typeof document === "undefined" ? require("url").pathToFileURL(__filename).href : _documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === "SCRIPT" && _documentCurrentScript.src || new URL("bundles/main-CofAb6dL.js", document.baseURI).href));
...
electron.app.whenReady().then(() => {
  ...
  electron.ipcMain.handle("dialog:openDirectory", async () => {
    ...
    const { canceled, filePaths } = await electron.dialog.showOpenDialog(parentWindow, {
