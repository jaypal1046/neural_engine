...
const __dirname$1 = path.dirname(node_url.fileURLToPath(typeof document === "undefined" ? require("url").pathToFileURL(__filename).href : _documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === "SCRIPT" && _documentCurrentScript.src || new URL("bundles/main-fgpTJCar.js", document.baseURI).href));
...
function createWindow() {
  win = new electron.BrowserWindow({
    ...
    webPreferences: {
      preload: path.join(DIST_ELECTRON_DIR, "preload.js"),
      webviewTag: true,
